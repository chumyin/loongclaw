        ...
        match mvp::provider::fetch_available_models(config).await {
            ...
            Err(error) => {
                ...
                let should_collect_route_probe = matches!(
                    ...
                    crate::provider_model_probe_policy::ProviderModelProbeRecoveryKind::TransportFailure
                );
...
fn onboard_check_from_provider_model_probe_failure(
    ...
    let non_interactive_warning_policy = match probe_failure.recovery_kind {
        crate::provider_model_probe_policy::ProviderModelProbeRecoveryKind::TransportFailure => {
            OnboardNonInteractiveWarningPolicy::Block
        }
        crate::provider_model_probe_policy::ProviderModelProbeRecoveryKind::ExplicitModel { .. } => {
            OnboardNonInteractiveWarningPolicy::AcceptedByExplicitModel
        }
        crate::provider_model_probe_policy::ProviderModelProbeRecoveryKind::PreferredModels { .. } => {
            OnboardNonInteractiveWarningPolicy::AcceptedByPreferredModels
        }
        crate::provider_model_probe_policy::ProviderModelProbeRecoveryKind::RequiresExplicitModel {
