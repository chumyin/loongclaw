...
// Keep doctor/onboard probes bounded, but leave enough slack for loaded
// developer and CI machines to spawn a local companion binary reliably.
...
mod tests {
    ...
    #[test]
    fn observed_version_matches_expected_rejects_partial_prefix_matches() {
        assert!(!observed_version_matches_expected(
