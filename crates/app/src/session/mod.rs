...
pub const DELEGATE_CANCEL_REQUESTED_EVENT_KIND: &str = "delegate_cancel_requested";
pub const DELEGATE_CANCELLED_EVENT_KIND: &str = "delegate_cancelled";
pub const DELEGATE_CANCEL_REASON_OPERATOR_REQUESTED: &str = "operator_requested";
pub const DELEGATE_CANCELLED_ERROR_PREFIX: &str = "delegate_cancelled:";

pub fn delegate_cancelled_error(reason: &str) -> String {
    format!(
...
pub fn parse_delegate_cancelled_reason(error: &str) -> Option<String> {
    error
