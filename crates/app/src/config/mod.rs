...
pub(crate) use channels::{
    ...
    NOSTR_PRIVATE_KEY_ENV, NOSTR_RELAY_URLS_ENV, ONEBOT_ACCESS_TOKEN_ENV, ONEBOT_WEBSOCKET_URL_ENV,
    QQBOT_APP_ID_ENV, QQBOT_CLIENT_SECRET_ENV, SIGNAL_ACCOUNT_ENV, SIGNAL_SERVICE_URL_ENV,
...
mod tests {
    ...
    fn channel_descriptor_lookup_reports_shared_metadata() {
        ...
        assert_eq!(mattermost.serve_subcommand, Some("mattermost-serve"));
